...
import { GetAllReviewsController } from "./controllers/getAllReviewsController";
...
export const getReviewAllUseCase = new GetReviewAllUseCase(mysqlReviewRepository);
...
export const getAllReviewsController = new GetAllReviewsController(getReviewAllUseCase)
